...
- `https://github.com/teogsxr/007-first-light-italian-dub/releases/tag/v0.4`
...
To rebuild the v0.4 package from local production state:
...
git status -sb
git add -A
git commit -m "Update v0.4 gameplay preview"
git push
git tag v0.4
git push origin v0.4
gh release create v0.4 ..\007-first-light-italian-dub-v0.4.zip --title "007 First Light Italian Dub v0.4" --notes-file RELEASE_NOTES.md
```

If the release already exists:

```powershell
gh release upload v0.4 ..\007-first-light-italian-dub-v0.4.zip --clobber
gh release edit v0.4 --title "007 First Light Italian Dub v0.4" --notes-file RELEASE_NOTES.md
```
